import { JournalEvent } from './types/events'
  ...
  switch (e.type) {
    ...
    case 'JournalEditorAdded':
      return {
        ...
        editors: {
          ...journal.editors,
          invited: [...journal.editors.invited, e.editorId]
        }
      }
    case 'JournalEditorConfirmed':
      return {
        ...
        editors: {
          ...
          confirmed: [...journal.editors.confirmed, e.confirmedEditorId]
        }
      }
