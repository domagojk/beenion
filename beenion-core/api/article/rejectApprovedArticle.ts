...
import { canRejectApprovedArticle } from 'domain/businessRules'
...
function rejectApprovedArticle (command: {
  userHistory: object[]
  ...
  if (!canRejectApprovedArticle(user, article, journal)) {
...
export default rejectApprovedArticle
