...
- [**Feb 6, 2019**](https://github.com/domagojk/beenion/tree/beenion-aws) - ([Serverless Event Sourcing in AWS (Lambda, DynamoDB, SQS)](https://medium.com/@domagojk/serverless-event-sourcing-in-aws-lambda-dynamodb-sqs-7237d79aed27))
